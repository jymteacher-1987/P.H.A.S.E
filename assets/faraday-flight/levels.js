(function (root, factory) {
  ...
  const levels = [
    ...
    },
    {
      ...
      tip: "기호의 미궁은 회전하는 기호탄과 X자 탄줄을 번갈아 쏴요. 회전 방향과 교차 지점을 읽어보세요.",
    ...
    },
    {
      ...
      obstacles: 0,
      intro: "마지막 하늘 · 기록의 등대\n남겨둔 기록이 길을 비춰줍니다",
      tip: "시계탄은 잠시 멈췄다 퍼지고, 메아리탄은 기록한 위치로 반복 발사돼요. 계속 추적하지 않으니 조준된 자리에서 벗어나세요.",
  ...
  const upgrades = [
    {
      ...
      icon: "◎",
      name: "구리 코일",
      desc: "무기 진화 +2 · 레이저 출력 +5.5% · 유도 전압 증가",
      max: 4,
    },
    {
      id: "rapid",
