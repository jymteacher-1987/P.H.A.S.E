...
- 초록 원 안의 번개 토큰은 오버드라이브를 위한 수집물이며 전하 하나나 실제 전지를 뜻하지 않습니다. 일반 토큰은 적 8기 격파마다 1개, 동시에 최대 4개이고 보스 보상은 4개입니다. 일반 부품은 10기마다 1개, 보스 보급은 14초마다 1개입니다. 축전기 아이템은 2·4스테이지에 각 1개만 등장하고 평행한 두 판 기호로 번개 토큰과 구별합니다. 모든 이로운 부품은 같은 원 테두리를 사용하고 과열 파편은 빨간 삼각형입니다. 구리 부품까지 끌어오는 수집 효과는 별도의 부품 회수 장치입니다.
