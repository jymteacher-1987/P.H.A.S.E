...
첫 화면은 주인공과 배경 두 그림만 기다립니다. 현재 장의 적·보스를 먼저 준비하고, 다음 장의 그림은 비행 시작 후 뒤에서 받습니다. 해당 장의 필수 그림이 준비되기 전에는 출발하지 않으며, 연결 오류가 나면 같은 화면에서 다시 준비할 수 있습니다. 웹 글꼴 응답이 게임 시작을 막지 않습니다. 원본 그림의 해상도나 애니메이션 프레임 수는 유지합니다.
