  ...
  "experiments": [
    {
      ...
      "path": "experiments/si-prefixes.html?v=3305d63d66",
      "date": "2026-07-28",
      "tags": [
        "단위",
        "측정",
    ...
    },
    {
      ...
      "path": "experiments/newton-laws.html?v=1830f25642",
      "date": "2026-07-28",
      "tags": [
        "뉴턴",
        "운동법칙",
    ...
    },
    {
      ...
      "lessonNote": {
        "question": "등속 원운동하는 공에 평행광선을 비추면, 그림자는 어떻게 움직일까요?",
        "focus": "평행광선을 켜고 ‘같이 출발’을 눌러, 공의 그림자와 용수철에 매단 추의 주기를 비교해 보세요."
      },
      "path": "experiments/shm-circular-motion.html?v=43ce65f9a0",
      "date": "2026-07-28",
      "tags": [
        "단진동",
        "원운동",
    ...
    },
    {
      ...
      "path": "experiments/rocket-motion.html?v=2b00d63f5e",
      "date": "2026-07-28",
      "tags": [
        "로켓",
        "운동량",
    ...
    },
    {
      ...
      "path": "experiments/motion-analysis.html?v=6153456833",
      "date": "2026-07-28",
      "tags": [
        "운동분석",
        "그래프",
    ...
    },
    {
      ...
      "path": "experiments/generator-principle.html?v=cde9f8cf35",
      "date": "2026-07-28",
      "tags": [
        "발전기",
        "교류",
    ...
    },
    {
      ...
      "path": "experiments/momentum-conservation.html?v=407c5e8380",
      "date": "2026-07-28",
      "tags": [
        "운동량 보존",
        "충돌",
    ...
    },
    {
      ...
      "path": "experiments/free-fall-projectile.html?v=2fad7b01c8",
      "date": "2026-07-28",
      "tags": [
        "자유낙하",
        "수평투사",
    ...
    },
    {
      ...
      "lessonNote": {
        ...
        "focus": "‘PN 접합’과 ‘PN 접합 실행’을 차례로 선택한 뒤, 순방향과 역방향에서 공핍층과 전자·양공의 움직임을 비교해 보세요."
      },
      "path": "experiments/pn-junction.html?v=636682a19e",
      "date": "2026-09-13",
      "tags": [
        "반도체",
        "PN 접합",
    ...
    },
    {
      ...
      "lessonNote": {
        ...
        "focus": "각 기준계에서 두 통과 사건의 시간 간격과 같은 시각에 측정한 두 행성 사이의 거리를 비교해 보세요."
      },
      "path": "experiments/proper-time-length.html?v=952f56d830",
      "date": "2026-07-31",
      "tags": [
        "특수상대성",
        "고유시간",
    ...
    },
    {
      ...
      "title": "이상 기체 상태 방정식",
      "category": "thermal",
      "description": "압력·부피·온도·기체의 양을 바꾸며 이상 기체 상태 방정식 PV = nRT를 확인합니다.",
      "lessonNote": {
        "question": "기체의 압력, 부피, 온도, 몰수 사이에는 어떤 관계가 있을까요?",
        "focus": "각 단계에서 일정하게 유지되는 변인을 확인하고, 나머지 두 변인의 관계를 비교해 보세요. 세 실험의 기록을 모아 PV = nRT가 성립하는지 확인해 보세요."
      },
      "path": "experiments/ideal-gas-law.html?v=9d4c9eba4a",
      "date": "2026-08-01",
      "tags": [
        "이상기체",
        "보일 법칙",
    ...
    },
    {
      ...
      "category": "relativity",
      "description": "같은 두 번개 사건을 지면과 기차의 기준계에서 살펴보고, 발생 시각을 비교합니다.",
      "lessonNote": {
        "question": "지면에서 동시에 친 두 번개는 기차에서도 동시에 친 것일까요?",
        "focus": "두 관점에서 번개가 친 시각과 빛이 관찰자에게 도착한 시각을 구분해 보세요."
      },
      "path": "experiments/simultaneity-relativity.html?v=fd55f796b3",
      "date": "2026-08-01",
      "tags": [
        "특수상대성",
        "동시성",
    ...
    },
    {
      ...
      "lessonNote": {
        ...
        "focus": "같은 조건으로 쏜 알파입자의 궤적을 톰슨 모형과 원자핵 모형에서 비교해 보세요."
      },
      "path": "experiments/rutherford-scattering.html?v=727afffd68",
      "date": "2026-08-20",
      "tags": [
        "러더퍼드",
        "원자 모형",
    ...
    },
    {
      ...
      "title": "베르누이의 원리",
      "category": "mechanics",
      "description": "관을 따라 흐르는 공기의 속력이 커질 때 압력과 분자의 움직임이 어떻게 달라지는지 관찰합니다.",
      "lessonNote": {
        "question": "같은 관을 따라 흐르는 공기의 속력이 커지면, 압력은 어떻게 달라질까요?",
        "focus": "빨라진 정도를 바꾸며 속력과 압력 값을 읽어 보세요. 벽에 부딪히는 횟수와 점선이 흘러가는 빠르기도 함께 비교해 보세요."
      },
      "path": "experiments/bernoulli-principle.html?v=448ab78452",
      "date": "2026-09-09",
      "tags": [
        "베르누이",
        "유체",
    ...
    },
    {
      ...
      "lessonNote": {
        ...
        "focus": "진동수를 일정하게 두고, 단위 시간당 광자 수만 바꿔 보세요. 별도의 실험에서는 단위 시간당 광자 수를 일정하게 두고, 진동수만 바꿔 보세요. 방출 여부·최대 운동 에너지·광전류를 비교하고, 금속별 한계 진동수와, 광전류가 0이 되는 정지 전압도 찾아보세요."
      },
      "path": "experiments/photoelectric-effect.html?v=df621cf927",
      "date": "2026-09-13",
      "tags": [
        "광전효과",
        "광자",
  ...
  "plays": [
    {
      ...
      "path": "plays/hero-maker.html?v=986cb4bd7b",
      "date": "2026-09-02",
      "tags": [
        "히어로",
        "과학 놀이",
    ...
    },
    {
      ...
      "path": "plays/newton-rush.html?v=962e444db0",
      "date": "2026-09-08",
      "tags": [
        "뉴턴",
        "달리기",
    ...
    },
    {
      ...
      "path": "plays/physics-fighter.html?v=5549d3114f",
      "date": "2026-09-09",
      "tags": [
        "물리학자",
        "격투",
    ...
    },
    {
      ...
      "icon": "🍎",
      "description": "선배 과학자들의 연구를 만나고 네 가지 실험으로 운동 법칙을 탐험합니다.",
      "path": "plays/giants-shoulders.html?v=49cf8feb41",
      "date": "2026-09-11",
      "tags": [
        "뉴턴",
        "과학사",
    ...
    },
    {
      ...
      "path": "plays/faraday-flight.html?v=a05edac374",
      "date": "2026-09-13",
      "tags": [
        "전자기 유도",
        "패러데이",
    ...
    },
    {
      ...
      "path": "plays/afterlight.html?v=35035f2817",
      "date": "2026-09-12",
      "tags": [
        "빛",
        "반사",
    ...
    },
    {
      ...
      "path": "plays/jjomuldak-factory.html?v=1ce4d14fa9",
      "date": "2026-09-05",
      "tags": [
        "뽁뽁이",
        "말랑이",
    ...
    },
    {
      ...
      "path": "plays/bamti-escape.html?v=e199f8dd9e",
      "date": "2026-09-12",
      "tags": [
        "밤티",
        "방탈출",
