...
// Keep fields added later (such as lessonNote) when refreshing an existing entry.
if (existing < 0) data.experiments.push(entry); else data.experiments[existing] = { ...data.experiments[existing], ...entry };
